package com.hibernate.tutorial.TablePerHierarchyXML;
...
public class Main {
	...
	public static void main(String[] args) {
		StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("com/hibernate/tutorial/TablePerHierarchyXML/Hibernate.cfg.xml").build();
