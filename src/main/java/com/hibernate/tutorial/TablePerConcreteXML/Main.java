package com.hibernate.tutorial.TablePerConcreteXML;
...
public class Main {
	...
	public static void main(String[] args) {
		StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("com/hibernate/tutorial/TablePerConcreteXML/Hibernate.cfg.xml").build();
